...
The plugin registers nine source nodes and eleven macro nodes of its own into
the Data Explorer's add-node menu. None of this was possible: the node set was a
