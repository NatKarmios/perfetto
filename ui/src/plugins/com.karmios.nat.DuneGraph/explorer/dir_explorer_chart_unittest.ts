...
/**
 * The per-directory narrowing button. It is the card's one brush, and the thing
 * to pin is the way back from it: a brush with no way to clear it leaves every
 * other card narrowed with nothing to undo.
 */
