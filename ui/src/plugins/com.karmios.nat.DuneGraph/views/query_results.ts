...
import type {PathTreeItem, PathTreeLeaf, PathTreeRow} from '../model/path_tree';
...
export class DuneQueryResults {
  ...
  // the response (or the loading flag) to render from.
  get rowCount(): number | undefined {
    return this.response?.totalRowCount;
  }
