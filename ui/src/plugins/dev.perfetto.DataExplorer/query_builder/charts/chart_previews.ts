...
// SVG preview renderers for the built-in chart types. Each returns a small
// schematic SVG that gives users a visual sense of what the chart looks like.
...
} satisfies Record<string, () => m.Children>;
